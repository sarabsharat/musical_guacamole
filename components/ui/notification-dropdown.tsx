...
// ─── Map the new NotificationType enum to Lucide Icons ────────
// components/ui/notification-dropdown.tsx
                    ...
                    <DropdownMenuGroup>
                        ...
                        <div className="max-h-75 overflow-y-auto">
                            {notifications.length > 0 ? (
                                notifications.map(({ id, textColor, title, desc, time, type }) => {
                                    const Icon = getIconForType(type); // 👈 Now reading the new type
